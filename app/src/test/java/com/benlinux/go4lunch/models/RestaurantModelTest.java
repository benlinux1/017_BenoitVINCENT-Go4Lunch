...
/**
 * Tests for Restaurant Model & getters
 */
public class RestaurantModelTest {
    ...
    @Test
    public void RestaurantGetAddress() {
    ...
    @Test
    public void RestaurantGetRating() {
    ...
    @Test
    public void RestaurantGetOpeningHours() {
    ...
    @Test
    public void RestaurantGetDistanceFromUser() {
    ...
    @Test
    public void RestaurantGetLatLng() {
    ...
    @Test
    public void RestaurantGetBookings() {
